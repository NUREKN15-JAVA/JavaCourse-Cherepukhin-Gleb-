...
import ua.nure.kn155.cherepukhin.agent.SearchException;
...
/*  private void initialize() {
  ...
  public void addUsers(Collection<User> users) {
    ...
    ((UserTableModel)getTable().getModel()).addUsers(users);
    this.repaint();
  }

  private void clearUsers() {
    System.out.println("clearUsers:");
    getTable().setModel(new UserTableModel(new LinkedList<>()));
    this.repaint();
  }
}
